...
# MILVUS_PORT = 19530
# MILVUS_COLLECTION = "L2_minilm_rag_3"

# # Get the base directory and create absolute path for SQLite database
# BASE_DIR = Path(__file__).resolve().parent.parent
# SQLITE_DB_PATH = os.path.join(BASE_DIR, "L2_minilm_sentences_3.db")
...
#             "Guidelines:\n"
#             "- Extract as much relevant information as possible from the context, and only answer using the information from the context, don't make up answers\n"
